...
public class AddActivity extends AppCompatActivity {
    ...
    /**
     * Nombre maximum d'exercices à créer.
     */
    ...
    private FloatingActionButton btn_addSet, btn_rmSet;
    ...
    private View.OnLongClickListener btn_addExoListener = new View.OnLongClickListener() {
        @SuppressLint("NewApi")
        @Override
        public boolean onLongClick(View v) {
            if (cpt_exo<NB_MAX_EXO-1){
                ...
                LinearLayout layout_exo = new LinearLayout(AddActivity.this);
                layout_exo.setOrientation(LinearLayout.HORIZONTAL);
                TextView lib_exo = new TextView(AddActivity.this);
                lib_exo.setText(getResources().getString(R.string.lib_nb_exo)+" "+(cpt_exo+1));
                EditText input_exo = new EditText(AddActivity.this);
    ...
    private View.OnClickListener btn_addSetListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            ...
            RelativeLayout layout_set = new RelativeLayout(AddActivity.this);
            TextView lib_set = new TextView(AddActivity.this);
            EditText input_min = new EditText(AddActivity.this);
            EditText input_sec = new EditText(AddActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText input_exo1 = (EditText) findViewById(R.id.input_exo1);
        input_exo1.setTag("exo"+cpt_exo);
        input_exo1.addTextChangedListener(new ControleurEditText(input_exo1));
        EditText input_timeMinute = (EditText) findViewById(R.id.input_timeMinute);
        input_timeMinute.setTag("exo"+cpt_exo+"_min"+1);
        EditText input_timeSecond = (EditText) findViewById(R.id.input_timeSecond);
        ...
        btn_addSet = (FloatingActionButton) findViewById(R.id.btn_addSet);
        btn_addSet.setOnClickListener(btn_addSetListener);
        btn_addSet.setOnLongClickListener(btn_addExoListener);
